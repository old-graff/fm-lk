    ...
    $.fn.extend({
        easyResponsiveTabs: function (options) {
            ...
            var defaults = {
                ...
                activetab_bg: '#f0f3fa',
                inactive_bg: '#d3d5d6',
                active_border_color: '#d3d5d6',
                active_content_border_color: '#d3d5d6',
                activate: function () {
                }
            }
            //Variables
